...
// mqtt_topics table stores all MQTT messages directly
// No dynamic table creation or metadata tracking needed
...
// Note: The mqtt_topics table defined in schema.graphql is exported as "/" and handles
// all MQTT publish/subscribe operations natively through HarperDB's @export mechanism.
// No custom resource class is needed.
